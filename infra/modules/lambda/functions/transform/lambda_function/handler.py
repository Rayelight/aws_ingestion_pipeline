...
from app.transform_service import process_transform_message
...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    for rec in records:
        ...
        try:
            ...
            process_transform_message(body)
        except Exception as e:
            logger.exception("transform_failed", extra={"message_id": msg_id, "error": str(e)})
